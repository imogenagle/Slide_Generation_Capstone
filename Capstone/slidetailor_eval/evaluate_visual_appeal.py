#!/usr/bin/env python3
"""Layout-focused visual appeal evaluation for SlideGen decks."""
...
DEFAULT_PROMPT_PATH = REPO_ROOT / "utils" / "prompt_templates" / "slidetailor_eval" / "visual_appeal.yaml"


def evaluate_visual_appeal(
    *,
    pptx_path: Path,
...
def main() -> None:
    ...
    output_path = resolve_output_path("visual_appeal", args.output, args.pptx_path.stem)
